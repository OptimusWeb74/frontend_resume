    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={()=>setShowUploadResume(true)} className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-purple-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <p
                  className="text-sm group-hover:sclae-105 transition-all px-2 text-center"
                  style={{ color: baseColor }}
                >
                  {resume.title}
                </p>
