  ...
  const cardsData = [
    {
      ...
      name: "Sarah N.",
      handle: "@sarah.marketing",
      text: "ResumeFlow helped me land my first remote marketing job! The templates are modern and easy to customize — I didn’t need any design skills.",
    },
    {
      image:
      ...
      name: "James O.",
      handle: "@james.dev",
      text: "I’ve tried other builders, but ResumeFlow made it effortless. I could edit and preview my resume in real time — no downloads needed!",
    },
    {
      image:
      ...
      name: "Anita K.",
      handle: "@hr.anita",
      text: "As an HR manager, I instantly recognize a good resume. ResumeFlow gives job seekers that professional edge recruiters love.",
    },
    {
      image:
        "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60",
      name: "David M.",
      handle: "@freelance.dave",
      text: "I use ResumeFlow to quickly create project-based resumes for my freelance gigs. The AI suggestions are spot on!",
    },
    {
      image:
        "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=200&auto=format&fit=crop&q=60",
      name: "Brenda L.",
      handle: "@student.brenda",
      text: "Creating my first resume felt easy and fun. The step-by-step builder and live preview gave me total confidence!",
    },
  ];
